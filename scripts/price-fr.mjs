...
const PRICES = {
  ...
  "agneau haché": { prix: 17, ref: "kg" },
  bacon: { prix: 12, ref: "kg" },
  "bœuf à mijoter": { prix: 15, ref: "kg" },
  "bœuf à pot-au-feu": { prix: 14, ref: "kg" },
  "bœuf émincé": { prix: 17, ref: "kg" },
  "bœuf haché": { prix: 12.5, ref: "kg" },
  ...
  "dos de cabillaud": { prix: 22, ref: "kg" },
  "émincé de poulet": { prix: 12.5, ref: "kg" },
  "escalope de poulet": { prix: 13, ref: "kg" },
  "filet de colin": { prix: 15, ref: "kg" },
  "filet de poisson blanc": { prix: 16, ref: "kg" },
  "filet de poulet": { prix: 12.5, ref: "kg" },
  ...
  lait: { prix: 1.3, ref: "L" },
  mozzarella: { prix: 10, ref: "kg" },
  œuf: { prix: 0.4, ref: "u" },
  parmesan: { prix: 25, ref: "kg" },
  "parmesan râpé": { prix: 28, ref: "kg" },
